...
define('CB_THEME_DIR', WP_CONTENT_DIR . '/themes/cb-peoplesafe');
...
require_once CB_THEME_DIR . '/inc/careers-functions.php';
...
function add_child_theme_textdomain() {
    load_child_theme_textdomain( 'cb-peoplesafe', get_stylesheet_directory() . '/languages' );
}
...
function widgets_init()
{
    ...
    register_sidebar(
        array(
            'name'          => __('Footer Col 1', 'cb-peoplesafe'),
            'id'            => 'footer-1',
            'description'   => __('Footer Col 1', 'cb-peoplesafe'),
    ...
    register_sidebar(
        array(
            'name'          => __('Footer Col 2', 'cb-peoplesafe'),
            'id'            => 'footer-2',
            'description'   => __('Footer Col 2', 'cb-peoplesafe'),
            'before_widget' => '<div id="%1$s" class="footer-widget %2$s">',
            'after_widget'  => '</div>',
        )
    );
    register_sidebar(
        array(
            'name'          => __('Footer Col 3', 'cb-peoplesafe'),
            'id'            => 'footer-3',
            'description'   => __('Footer Col 3', 'cb-peoplesafe'),
            'before_widget' => '<div id="%1$s" class="footer-widget %2$s">',
            'after_widget'  => '</div>',
        )
    );
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-peoplesafe'),
    ));
    // register_nav_menus(array(
    //     'sidebar_nav' => __('Sidebar  Nav', 'cb-peoplesafe'),
    // ));

    register_nav_menus(array(
        'footer_menu1' => __('Footer Products', 'cb-peoplesafe'),
        'footer_menu2' => __('Footer Resources', 'cb-peoplesafe'),
    ));
